...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Duelo Pokemon" },
      { name: "description", content: "🐾 Colecione Pokémon, evolua criaturas raras e lute em batalhas épicas na Duelo Pokemon! Suba de rank, desbloqueie Pokémon lendários e torne-se o mestre definitivo!" },
      { name: "author", content: "Duelo Pokemon" },
      { property: "og:title", content: "Duelo Pokemon" },

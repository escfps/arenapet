...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/p6KDJiGVqkXbPJ2azby07G2iWED2/social-images/social-1779428464611-IMG_1285.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/p6KDJiGVqkXbPJ2azby07G2iWED2/social-images/social-1779428464611-IMG_1285.webp" },

...
const ALL_CATEGORIES: Category[] = ["normal","fire","water","grass","electric","ice","fighting","poison","ground","flying","psychic","bug","rock","ghost","dragon","dark","steel","fairy"];
...
function PatioPage() {
  ...
  return (
    ...
    >
      ...
      {(!profile.welcome_chest_claimed || welcomeReveal) && (
        <WelcomeChestModal
          hatching={hatching}

...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    title: "2/7 — Treine um pet",
    body:
      "Treinar deixa seus pets MUITO mais fortes! Toque no botão 💪 UP de qualquer pet pra ver os atributos e gastar moedas treinando.",
    advance: "click",
    requiredRoute: "/",

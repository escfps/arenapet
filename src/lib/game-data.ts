...
export const SPECIES: Record<string, Species> = {
  ...
  rato_bomba: {
    ...
    base: { hp: 50, atk: 16, def: 7, spd: 17, int: 8 },
  ...
  steamcub: {
    ...
    base: { hp: 50, atk: 9, def: 14, spd: 9, int: 8 },
  ...
  emberleaf: {
    ...
    base: { hp: 32, atk: 13, def: 9, spd: 12, int: 7 },
  ...
  cinderwisp: {
    ...
    base: { hp: 30, atk: 14, def: 9, spd: 11, int: 22 },
  ...
  mossfin: {
    ...
    base: { hp: 38, atk: 8, def: 12, spd: 10, int: 20 },
  ...
  stormtad: {
    ...
    base: { hp: 28, atk: 13, def: 8, spd: 14, int: 22 },
  ...
  tidewraith: {
    ...
    base: { hp: 24, atk: 12, def: 8, spd: 16, int: 6 },
  ...
  voltsprout: {
    ...
    base: { hp: 34, atk: 9, def: 11, spd: 12, int: 20 },
  ...
  nightbloom: {
    ...
    base: { hp: 32, atk: 13, def: 10, spd: 10, int: 22 },
  ...
  voidspark: {
    ...
    base: { hp: 64, atk: 13, def: 7, spd: 17, int: 6 },
  ...
  rockpup: {
    ...
    base: { hp: 95, atk: 9, def: 20, spd: 7, int: 8 },
  ...
  magmaboulder: {
    ...
    base: { hp: 55, atk: 11, def: 16, spd: 7, int: 8 },
  ...
  mudpaw: {
    ...
    base: { hp: 40, atk: 14, def: 12, spd: 8, int: 7 },
  ...
  crystalsprite: {
    ...
    base: { hp: 72, atk: 12, def: 11, spd: 10, int: 21 },
  ...
  dragao_fogo: {
    ...
    base: { hp: 70, atk: 11, def: 11, spd: 12, int: 23 },
  ...
  foca_glacial: {
    ...
    base: { hp: 74, atk: 7, def: 11, spd: 10, int: 21 },

...
export const SPECIES: Record<string, Species> = {
  ...
  flarepup: {
    ...
    base: { hp: 105, atk: 15, def: 8, spd: 12, int: 7 },
  ...
  aquakitty: {
    ...
    base: { hp: 110, atk: 9, def: 11, spd: 13, int: 20 },
  ...
  leafox: {
    ...
    base: { hp: 130, atk: 8, def: 18, spd: 8, int: 8 },
  ...
  voltbun: {
    ...
    base: { hp: 98, atk: 13, def: 8, spd: 18, int: 6 },
  ...
  shadepup: {
    ...
    base: { hp: 105, atk: 16, def: 9, spd: 12, int: 22 },
  ...
  rato_bomba: {
    ...
    base: { hp: 90, atk: 16, def: 7, spd: 17, int: 8 },
  ...
  steamcub: {
    ...
    base: { hp: 120, atk: 9, def: 14, spd: 9, int: 8 },
  ...
  emberleaf: {
    ...
    base: { hp: 102, atk: 13, def: 9, spd: 12, int: 7 },
  ...
  sparkpup: {
    ...
    base: { hp: 96, atk: 12, def: 8, spd: 16, int: 6 },
  ...
  cinderwisp: {
    ...
    base: { hp: 100, atk: 14, def: 9, spd: 11, int: 22 },
  ...
  mossfin: {
    ...
    base: { hp: 108, atk: 8, def: 12, spd: 10, int: 20 },
  ...
  stormtad: {
    ...
    base: { hp: 98, atk: 13, def: 8, spd: 14, int: 22 },
  ...
  tidewraith: {
    ...
    base: { hp: 94, atk: 12, def: 8, spd: 16, int: 6 },
  ...
  voltsprout: {
    ...
    base: { hp: 104, atk: 9, def: 11, spd: 12, int: 20 },
  ...
  nightbloom: {
    ...
    base: { hp: 102, atk: 13, def: 10, spd: 10, int: 22 },
  ...
  voidspark: {
    ...
    base: { hp: 94, atk: 13, def: 7, spd: 17, int: 6 },
  ...
  rockpup: {
    ...
    base: { hp: 135, atk: 9, def: 20, spd: 7, int: 8 },
  ...
  magmaboulder: {
    ...
    base: { hp: 125, atk: 11, def: 16, spd: 7, int: 8 },
  ...
  mudpaw: {
    ...
    base: { hp: 110, atk: 14, def: 12, spd: 8, int: 7 },
  ...
  crystalsprite: {
    ...
    base: { hp: 102, atk: 12, def: 11, spd: 10, int: 21 },
  ...
  onca_sombria: {
    ...
    base: { hp: 112, atk: 17, def: 10, spd: 16, int: 10 },
  ...
  leao_dourado: {
    ...
    base: { hp: 118, atk: 18, def: 13, spd: 11, int: 9 },
  ...
  tigre_infernal: {
    ...
    base: { hp: 114, atk: 19, def: 10, spd: 14, int: 10 },
  ...
  pantera_negra: {
    ...
    base: { hp: 110, atk: 18, def: 10, spd: 17, int: 11 },
  ...
  pantera_aurea: {
    ...
    base: { hp: 115, atk: 14, def: 12, spd: 15, int: 24 },
  ...
  macaco_prego: {
    ...
    base: { hp: 100, atk: 14, def: 9, spd: 18, int: 9 },
  ...
  polvo_venenoso: {
    ...
    base: { hp: 108, atk: 13, def: 11, spd: 12, int: 24 },
  ...
  cobra_sangrenta: {
    ...
    base: { hp: 100, atk: 15, def: 9, spd: 13, int: 8 },
  ...
  borboleta_sonifera: {
    ...
    base: { hp: 108, atk: 15, def: 12, spd: 20, int: 20 },
  ...
  urso_polar: {
    ...
    base: { hp: 121, atk: 25, def: 12, spd: 13, int: 10 },
  ...
  gorila_titan: {
    ...
    base: { hp: 114, atk: 13, def: 14, spd: 8, int: 9 },
  ...
  lobo_lua_sangrenta: {
    ...
    base: { hp: 125, atk: 25, def: 15, spd: 22, int: 15 },
  ...
  dragao_branco: {
    ...
    base: { hp: 130, atk: 16, def: 16, spd: 14, int: 26 },
  ...
  dragao_negro: {
    ...
    base: { hp: 125, atk: 24, def: 14, spd: 15, int: 14 },
  ...
  fenix_vermelha: {
    ...
    base: { hp: 125, atk: 24, def: 14.29, spd: 15, int: 14 },
  ...
  fenix_negra: {
    ...
    base: { hp: 128, atk: 25.72, def: 13.14, spd: 14, int: 14 },
  ...
  fenix_azul: {
    ...
    base: { hp: 102, atk: 8, def: 11, spd: 11, int: 20 },
  ...
  foca_glacial: {
    ...
    base: { hp: 104, atk: 7, def: 11, spd: 10, int: 21 },
  ...
  lobo_artico: {
    ...
    base: { hp: 106, atk: 19, def: 10, spd: 19, int: 9 },
  ...
  tartaruga_ancestral: {
    ...
    base: { hp: 145, atk: 9, def: 22, spd: 7, int: 10 },
  ...
  corvo_sombras: {
    ...
    base: { hp: 105, atk: 11, def: 10, spd: 14, int: 23 },
  ...
  lince_dourado: {
    ...
    base: { hp: 100, atk: 15, def: 8, spd: 19, int: 9 },
  ...
  leoa_trovao: {
    ...
    base: { hp: 110, atk: 19, def: 11, spd: 18, int: 11 },
  ...
  panda: {
    ...
    base: { hp: 130, atk: 11, def: 16, spd: 9, int: 24 },
  ...
  golem_pedra: {
    ...
    base: { hp: 120, atk: 10, def: 18, spd: 8, int: 22 },
  ...
  trex: {
    ...
    base: { hp: 125, atk: 22, def: 13, spd: 13, int: 10 },
  ...
  pterossauro: {
    ...
    base: { hp: 100, atk: 15, def: 9, spd: 19, int: 9 },
  ...
  triceratops_colossal: {
    ...
    base: { hp: 150, atk: 11, def: 22, spd: 7, int: 9 },
  ...
  fantasminha: {
    ...
    base: { hp: 126, atk: 14, def: 13, spd: 16, int: 28 },
  ...
  raposa_espectral: {
    ...
    base: { hp: 108, atk: 22, def: 9, spd: 21, int: 10 },
  ...
  orangotango: {
    ...
    base: { hp: 132, atk: 9, def: 14, spd: 8, int: 28 },
  ...
  porco_espinho: {
    ...
    base: { hp: 108, atk: 10, def: 16, spd: 9, int: 7 },
  ...
  arara_corsaria: {
    ...
    base: { hp: 92, atk: 30, def: 9, spd: 20, int: 11 },
    skill: { name: "Rajada Corsária", emoji: "🦜", kind: "corsair_volley", cooldown: 3, description: "Realiza 3 investidas rápidas em alvos ALEATÓRIOS (podem repetir no mesmo alvo, até as 3 no mesmo). Cada hit causa ATK×0.4 e tem 20% de chance de aplicar 🩸 sangramento por 2 turnos (15% do ATK por turno, máx 1 stack por alvo)." },
  },
  tigre_relampago: {

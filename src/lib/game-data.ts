...
export const SPECIES: Record<string, Species> = {
  ...
  steamcub: {
    ...
    base: { hp: 90, atk: 9, def: 14, spd: 9, int: 8 },
  ...
  emberleaf: {
    ...
    base: { hp: 72, atk: 13, def: 9, spd: 12, int: 7 },
  ...
  sparkpup: {
    ...
    base: { hp: 66, atk: 12, def: 8, spd: 16, int: 6 },
  ...
  cinderwisp: {
    ...
    base: { hp: 70, atk: 14, def: 9, spd: 11, int: 22 },
  ...
  mossfin: {
    ...
    base: { hp: 78, atk: 8, def: 12, spd: 10, int: 20 },
  ...
  stormtad: {
    ...
    base: { hp: 68, atk: 13, def: 8, spd: 14, int: 22 },
  ...
  tidewraith: {
    ...
    base: { hp: 64, atk: 12, def: 8, spd: 16, int: 6 },
  ...
  voltsprout: {
    ...
    base: { hp: 74, atk: 9, def: 11, spd: 12, int: 20 },
  ...
  nightbloom: {
    ...
    base: { hp: 72, atk: 13, def: 10, spd: 10, int: 22 },
  ...
  magmaboulder: {
    ...
    base: { hp: 95, atk: 11, def: 16, spd: 7, int: 8 },
  ...
  mudpaw: {
    ...
    base: { hp: 80, atk: 14, def: 12, spd: 8, int: 7 },

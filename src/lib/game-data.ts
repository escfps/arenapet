...
export const SPECIES: Record<string, Species> = {
  ...
  farfetchd: {
    id: "farfetchd", name: "Farfetch'd", element: "electric", role: "dps", rarity: "rare",
  ...
  doduo: {
    id: "doduo", name: "Doduo", element: "electric", role: "dps", rarity: "common",
  ...
  dodrio: {
    id: "dodrio", name: "Dodrio", element: "electric", role: "dps", rarity: "super_rare",

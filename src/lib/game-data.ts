...
export const SPECIES: Record<string, Species> = {
  ...
  emberleaf: {
    ...
    base: { hp: 21, atk: 13, def: 9, spd: 12, int: 7 },
  ...
  sparkpup: {
    ...
    base: { hp: 17, atk: 12, def: 8, spd: 16, int: 6 },
  ...
  cinderwisp: {
    ...
    base: { hp: 20, atk: 14, def: 9, spd: 11, int: 22 },
  ...
  mossfin: {
    ...
    base: { hp: 25, atk: 8, def: 12, spd: 10, int: 20 },
  ...
  stormtad: {
    ...
    base: { hp: 18, atk: 13, def: 8, spd: 14, int: 22 },
  ...
  voltsprout: {
    ...
    base: { hp: 22, atk: 9, def: 11, spd: 12, int: 20 },
  ...
  nightbloom: {
    ...
    base: { hp: 21, atk: 13, def: 10, spd: 10, int: 22 },
  ...
  urso_polar: {
    ...
    base: { hp: 79, atk: 25, def: 12, spd: 13, int: 10 },
  ...
  tartaruga_ancestral: {
    ...
    base: { hp: 94, atk: 9, def: 22, spd: 7, int: 10 },
  ...
  triceratops_colossal: {
    ...
    base: { hp: 98, atk: 11, def: 22, spd: 7, int: 9 },
  ...
  rinoceronte_guardiao: {
    ...
    base: { hp: 130, atk: 14, def: 32, spd: 9, int: 8 },
  ...
  coruja_psiquica: {
    ...
    base: { hp: 75, atk: 12, def: 12, spd: 18, int: 36 },

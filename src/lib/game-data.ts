...
export const SPECIES: Record<string, Species> = {
  ...
  flarepup: {
    ...
    base: { hp: 155, atk: 15, def: 8, spd: 12, int: 7 },
  ...
  aquakitty: {
    ...
    base: { hp: 160, atk: 9, def: 11, spd: 13, int: 20 },
  ...
  leafox: {
    ...
    base: { hp: 180, atk: 8, def: 18, spd: 8, int: 8 },
  ...
  voltbun: {
    ...
    base: { hp: 148, atk: 13, def: 8, spd: 18, int: 6 },
  ...
  shadepup: {
    ...
    base: { hp: 155, atk: 16, def: 9, spd: 12, int: 22 },
  ...
  rato_bomba: {
    ...
    base: { hp: 140, atk: 16, def: 7, spd: 17, int: 8 },
  ...
  steamcub: {
    ...
    base: { hp: 170, atk: 9, def: 14, spd: 9, int: 8 },
  ...
  emberleaf: {
    ...
    base: { hp: 152, atk: 13, def: 9, spd: 12, int: 7 },
  ...
  sparkpup: {
    ...
    base: { hp: 146, atk: 12, def: 8, spd: 16, int: 6 },
  ...
  cinderwisp: {
    ...
    base: { hp: 150, atk: 14, def: 9, spd: 11, int: 22 },
  ...
  mossfin: {
    ...
    base: { hp: 158, atk: 8, def: 12, spd: 10, int: 20 },
  ...
  stormtad: {
    ...
    base: { hp: 148, atk: 13, def: 8, spd: 14, int: 22 },
  ...
  tidewraith: {
    ...
    base: { hp: 144, atk: 12, def: 8, spd: 16, int: 6 },
  ...
  voltsprout: {
    ...
    base: { hp: 154, atk: 9, def: 11, spd: 12, int: 20 },
  ...
  nightbloom: {
    ...
    base: { hp: 152, atk: 13, def: 10, spd: 10, int: 22 },
  ...
  voidspark: {
    ...
    base: { hp: 144, atk: 13, def: 7, spd: 17, int: 6 },
  ...
  rockpup: {
    ...
    base: { hp: 185, atk: 9, def: 20, spd: 7, int: 8 },
  ...
  magmaboulder: {
    ...
    base: { hp: 175, atk: 11, def: 16, spd: 7, int: 8 },
  ...
  mudpaw: {
    ...
    base: { hp: 160, atk: 14, def: 12, spd: 8, int: 7 },
  ...
  crystalsprite: {
    ...
    base: { hp: 152, atk: 12, def: 11, spd: 10, int: 21 },
  ...
  onca_sombria: {
    ...
    base: { hp: 162, atk: 17, def: 10, spd: 16, int: 10 },
  ...
  leao_dourado: {
    ...
    base: { hp: 168, atk: 18, def: 13, spd: 11, int: 9 },
  ...
  tigre_infernal: {
    ...
    base: { hp: 164, atk: 19, def: 10, spd: 14, int: 10 },
  ...
  pantera_negra: {
    ...
    base: { hp: 160, atk: 18, def: 10, spd: 17, int: 11 },
  ...
  pantera_aurea: {
    ...
    base: { hp: 165, atk: 14, def: 12, spd: 15, int: 24 },
  ...
  macaco_prego: {
    ...
    base: { hp: 150, atk: 14, def: 9, spd: 18, int: 9 },
  ...
  tubarao_abissal: {
    ...
    base: { hp: 160, atk: 17, def: 11, spd: 13, int: 8 },
  ...
  polvo_venenoso: {
    ...
    base: { hp: 158, atk: 13, def: 11, spd: 12, int: 24 },
  ...
  cobra_sangrenta: {
    ...
    base: { hp: 150, atk: 15, def: 9, spd: 13, int: 8 },
  ...
  borboleta_sonifera: {
    ...
    base: { hp: 158, atk: 15, def: 12, spd: 20, int: 20 },
  ...
  urso_polar: {
    ...
    base: { hp: 171, atk: 25, def: 12, spd: 13, int: 10 },
  ...
  jacare_ancestral: {
    ...
    base: { hp: 156, atk: 15, def: 10, spd: 11, int: 8 },
  ...
  gorila_titan: {
    ...
    base: { hp: 164, atk: 13, def: 14, spd: 8, int: 9 },
  ...
  aguia_cega: {
    ...
    base: { hp: 155, atk: 18, def: 9, spd: 22, int: 10 },
  ...
  lobo_lua_sangrenta: {
    ...
    base: { hp: 175, atk: 25, def: 15, spd: 22, int: 15 },
  ...
  dragao_branco: {
    ...
    base: { hp: 180, atk: 16, def: 16, spd: 14, int: 26 },
  ...
  dragao_negro: {
    ...
    base: { hp: 175, atk: 24, def: 14, spd: 15, int: 14 },
  ...
  fenix_vermelha: {
    ...
    base: { hp: 175, atk: 24, def: 14.29, spd: 15, int: 14 },
  ...
  fenix_negra: {
    ...
    base: { hp: 178, atk: 25.72, def: 13.14, spd: 14, int: 14 },
  ...
  fenix_azul: {
    ...
    base: { hp: 152, atk: 8, def: 11, spd: 11, int: 20 },
  ...
  dragao_fogo: {
    ...
    base: { hp: 150, atk: 9, def: 10, spd: 11, int: 20 },
  ...
  foca_glacial: {
    ...
    base: { hp: 154, atk: 7, def: 11, spd: 10, int: 21 },
  ...
  lobo_artico: {
    ...
    base: { hp: 156, atk: 19, def: 10, spd: 19, int: 9 },
  ...
  tartaruga_ancestral: {
    ...
    base: { hp: 195, atk: 9, def: 22, spd: 7, int: 10 },
  ...
  corvo_sombras: {
    ...
    base: { hp: 155, atk: 11, def: 10, spd: 14, int: 23 },
  ...
  lince_dourado: {
    ...
    base: { hp: 150, atk: 15, def: 8, spd: 19, int: 9 },
  ...
  leoa_trovao: {
    ...
    base: { hp: 160, atk: 19, def: 11, spd: 18, int: 11 },
  ...
  panda: {
    ...
    base: { hp: 180, atk: 11, def: 16, spd: 9, int: 24 },
  ...
  golem_pedra: {
    ...
    base: { hp: 170, atk: 10, def: 18, spd: 8, int: 22 },
  ...
  trex: {
    ...
    base: { hp: 175, atk: 22, def: 13, spd: 13, int: 10 },
  ...
  pterossauro: {
    ...
    base: { hp: 150, atk: 15, def: 9, spd: 19, int: 9 },
  ...
  triceratops_colossal: {
    ...
    base: { hp: 200, atk: 11, def: 22, spd: 7, int: 9 },
  ...
  fantasminha: {
    ...
    base: { hp: 176, atk: 14, def: 13, spd: 16, int: 28 },
  ...
  raposa_espectral: {
    ...
    base: { hp: 158, atk: 22, def: 9, spd: 21, int: 10 },
  ...
  orangotango: {
    ...
    base: { hp: 182, atk: 9, def: 14, spd: 8, int: 28 },
  ...
  porco_espinho: {
    ...
    base: { hp: 158, atk: 10, def: 16, spd: 9, int: 7 },
  ...
  urubu_carniceiro: {
    ...
    base: { hp: 178, atk: 28, def: 12, spd: 22, int: 15 },

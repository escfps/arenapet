...
REVOKE ALL ON FUNCTION public.apply_arena_defender_result(uuid, boolean, int, int) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.apply_arena_defender_result(uuid, boolean, int, int) TO authenticated;
